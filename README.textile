...
!https://travis-ci.org/textpattern/textpattern-forum.svg?branch=master!:https://travis-ci.org/textpattern/textpattern-forum !https://david-dm.org/philwareham/hive-framework/dev-status.svg(devDependency Status)!:https://david-dm.org/textpattern/textpattern-forum#info=devDependencies !https://cdn.gruntjs.com/builtwith.png(Built with Grunt)!:http://gruntjs.com/
