...
* Added: Try to render sharing buttons block more smoothly; hide them until all the scripts have finished.
...
* Changed: Remove boxshadow Modernizr test - amend @:focus@ CSS rules for buttons and form elements accordingly.
