        ...
        <div class="nav-container">
            <nav class="site-navigation" aria-label="Site navigation" itemscope itemtype="http://schema.org/SiteNavigationElement">
                <ul>
                    ...
                    <li><a itemprop="url" href="http://themes.textpattern.com/">Themes</a></li>
...
<!-- Secondary Content -->
    <aside class="container complementary-content">
        ...
        <div class="layout--span-1-8">
            <section class="layout--span-1-6 at-break2" itemscope itemtype="http://schema.org/Organization">
            ...
            <section class="layout--span-7-12 at-break2 community-details">
        ...
        <section class="layout--span-9-12 host-details">
            <h4 class="accessibility">Host details</h4>
            <p><img src="style/Textpattern/img/branding/textpattern-network/textpattern-network-white.svg" alt="Textpattern Network"></p>
            <p>
                <small>
                    Kindly hosted by<br>
                    <a class="joyent" rel="external" href="http://joyent.com/" title="Go to the Joyent website"><img src="style/Textpattern/img/branding/misc/joyent-inverse.svg" alt="Joyent"></a>
                </small>
            </p>
        </section>
