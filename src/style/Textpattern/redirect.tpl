...
<body id="page-redirect" itemscope itemtype="http://schema.org/WebPage">
    <div class="wrapper">
    ...
    <div class="container" role="complementary" itemscope itemtype="http://schema.org/WPSideBar">
        ...
        <div class="layout--span-1-8">
            <section class="layout--span-1-6 at-break2" role="region">
                ...
                <ul class="social-channels">
                    <li><a class="facebook" rel="external" href="http://textpattern.com/facebook" title="Follow us on Facebook+">Facebook</a></li>
                    <li><a class="twitter" rel="external" href="http://textpattern.com/@textpattern" title="Follow us on Twitter">Twitter</a></li>
                    <li><a class="googleplus" rel="external" href="http://textpattern.com/+" title="Follow us on Google+">Google+</a></li>
                </ul>
                <h4>Donate</h4>
            ...
            <section class="layout--span-7-12 at-break2 community-details" role="region">
        ...
        <section class="layout--span-9-12 host-details" role="region">
            ...
            <p>
                <small>
                    Kindly hosted by<br>
                    <a class="joyent" rel="external" href="http://joyent.com/" title="Go to the Joyent website"><img class="svg" src="style/Textpattern/img/branding/misc/joyent-inverse.svg" alt="Joyent"></a>
                </small>
            </p>
        </section>
