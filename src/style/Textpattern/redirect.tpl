    ...
    <aside class="container complementary-content">
        ...
        <div class="layout-container">
            ...
            <section class="layout-3col host-details">
                ...
                <p><img src="http://textpattern.com/assets/img/branding/textpattern-network/textpattern-network-white.svg" alt="Textpattern Network"></p>
                <p>
                    <small>
                        Kindly hosted by<br>
                        <a class="joyent" rel="external" href="http://joyent.com/" title="Go to the Joyent website"><img src="http://textpattern.com/assets/img/branding/misc/joyent-inverse.svg" alt="Joyent"></a>
                    </small>
                </p>
            </section>
        </div><!-- /.layout-container -->
