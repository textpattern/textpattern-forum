...
<p>Most of the email addresses we ban are those which have been used to abuse the forum. Some email domains, however, are banned only because those email domain providers refuse to accept the registration email that the forum software sends (which is required, as mentioned above), and bounce the email back to us. While we make all possible efforts on our part to reduce the risk of undeliverable mail, it is recommended that you <a href="http://textpattern.com/faq/207/why-cant-i-create-a-forum-account" rel="external">check to see if your email address domain is one of those known to be affected</a>. If so, you will need to provide an alternate email address—we apologise for any inconvenience.</p>'
);
